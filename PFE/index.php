...
<section>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="cars.png" class="rounded" alt="Ma photo" style="width: 600px; display: block;height: 250px; margin: 0 auto;">
    </div>
    <div class="carousel-item">
      <img src="tel.png" class="rounded" alt="Ma photo" style="width: 800px; display: block;height: 250px; margin: 0 auto;">
    </div>
  </div>
...
<div class="row">
  <div class="col-sm-6 mb-3">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">GPU GTX 1080</h3>
        <img src="OIP.png">
        <a href="#" class="btn btn-primary" style="margin-top: 15px;">more information</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
...
<center><h2 class="font-weight-bold">TOP SELLS</h2></center><br>
    </div>
  </div> 
</div>
</section>
